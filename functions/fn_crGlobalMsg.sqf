...
switch (_msgType) do {
    ...
    case 6: {systemChat (format [localize "STR_CR_VILLAGERS_TALK", (_data select 0)]);};
    case 7: {systemChat (format [localize "STR_CR_VILLAGERS_ANGRY", (_data select 0)]);};
    case 8: {systemChat (format [localize "STR_CR_VILLAGERS_NO_LONGER_HUNTING", (_data select 0)]);};
    case 9: {systemChat (format [localize "STR_CR_VILLAGERS_REVENGE", (_data select 0)]);};
